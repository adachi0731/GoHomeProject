			...
			<table border="1">
				...
				<tr>
					...
					<td><c:forEach var="assortment" items="${assortmentList}">
								<c:if test="${assortment.assortmentCode==itemVo.assortmentCode }">${assortment.assortmentName}
								</c:if>
						</c:forEach>
				...
				<tr>
					...
					<td><c:forEach var="category" items="${categoryList}">
							<c:if test="${category.categoryCode==itemVo.categoryCode }">${category.categoryName}
							</c:if>
						</c:forEach>
